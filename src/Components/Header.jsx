            ...
            <div className="container">
                <a href="/">
                    <div className="header__logo">
                        <img width="38" src="https://i.pinimg.com/564x/84/a6/1b/84a61b6797fa8efa95eaf62b2bfab80e.jpg" alt="Durum logo" />
                        <div>
                            <h1>React durum</h1>
                ...
                <div className="Search_root__eiX89">
                    <svg className="Search_icon__XMmYc" width="30" height="30" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <input className="Search_input__klILD" placeholder="Поиск duruma..." defaultValue="" />
                </div>
