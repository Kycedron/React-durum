		...
		<div class="header">
				<div class="container">
					...
					<div class="Search_root__eiX89">
						<svg class="Search_icon__XMmYc" width="30" height="30" enable-background="new 0 0 32 32" id="EditableLine" version="1.1" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
